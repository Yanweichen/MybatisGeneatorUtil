...
public class FullyQualifiedTable {
    ...
    public String getDomainObjectName() {
        if (stringHasValue(domainObjectName)) {
            ...
            String modifyTableName = introspectedTableName;
            if (introspectedTableName!=null && introspectedTableName.startsWith("T_")){
                modifyTableName = introspectedTableName.substring(2);
            }
            return getCamelCaseString(modifyTableName, true);
        }
    }
